...
unRAID Docker Templates for Docker images in the "tremblex" repository.
...
2. Enter in a URL of https://github.com/tremblex/blex-docker-templates in the "Template repositories" field
